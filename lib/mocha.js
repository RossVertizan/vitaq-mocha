...
var debug = require('debug')('vitaq_mocha:mocha');
...
function Mocha(options = {}) {
  ...
  // A feature to allow debugging - a way to see what we have
  if ('showMochaDetails' in options && options.showMochaDetails) {
    console.info(
      '\n================================================================================\n' +
        `=                Vitaq Mocha (vitaqai-mocha version: ${version})                      =\n` +
        '================================================================================\n'
    );
  }

  // Read the cleanReferencesAfterRun option
  // If standardMocha is true then overwrite this
  if ('standardMocha' in options && options.standardMocha) {
    // pass
  }
  // Always true to make cleanReferencesAfterRun to default to false
  // Remove the || true to go back to something that will work in Mocha
  // eslint-disable-next-line no-constant-condition
  else if ('cleanReferencesAfterRun' in options || true) {
 ...
 *   arg=true,      true      !== false -> true
 *   arg=undefined, undefined !== false -> true
 *
 *   arg=false,     false     === true -> false
 *   arg=true,      true      === true -> true
 *   arg=undefined, undefined === true -> false
 *
 */
Mocha.prototype.cleanReferencesAfterRun = function(cleanReferencesAfterRun) {
  debug('cleanReferencesAfterRun: ', cleanReferencesAfterRun);
  // Changed '!== false' to '=== true' - see table above to change default to false
  this._cleanReferencesAfterRun = cleanReferencesAfterRun === true;
  debug('cleanReferencesAfterRun: ', cleanReferencesAfterRun);
  return this;
};
